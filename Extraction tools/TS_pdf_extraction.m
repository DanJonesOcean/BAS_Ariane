%% TS_pdf_extraction.m
%{
 Plots the start and end position of the particles from an extraction, as
 in Extraction_plot.m, and the probability density functions at the 
 begining and end of the run.
